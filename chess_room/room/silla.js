...
class Silla extends THREE.Object3D {
    constructor() {
        super();
        //https://free3d.com/3d-model/chair-v1--401627.html
        var materialLoader = new MTLLoader();
        var objectLoader = new OBJLoader();
        materialLoader.load('../models/silla/12283_Chair_v1_L3.mtl',
            (materials) => {
                objectLoader.setMaterials(materials);
                objectLoader.load('../models/silla/12283_Chair_v1_L3.obj',
                    (object) => {
                        object.position.z = 50;
                        object.position.x = 10;
                        object.rotateY(2*Math.PI/8);
